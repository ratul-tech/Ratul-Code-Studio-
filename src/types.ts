...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  biography: 'I am an independent web developer in the path of mastery of the art of modern software prototyping. Since 2025, I have been learning how to use Vibe coding and LLMs in the creation of web apps. I try to be fast in my prototyping by using my powers of thinking and prompting in tandem with my knowledge of web dev.',
  ...
  pillar1Title: 'Vibe Coding & LLMs',
  pillar1Desc: 'Leveraging LLMs and conversational coding since 2025 to synthesize web applications rapidly.',
  ...
  footerText: 'Shahriar Islam Ratul. Built with passion & Vibe coding.'
};
